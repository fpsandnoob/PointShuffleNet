...
from log.classification.pn2_1024.pointnet_util import PointNetSetAbstraction
...
#
# class get_mixloss(nn.Module):
#     def __init__(self):
#         super(get_mixloss, self).__init__()
#
#     def forward(self,  pred, target, target_hat, lam, trans_feat):
#
#         loss = F.nll_loss(pred, target, reduction='none')
#         loss_hat = F.nll_loss(pred, target_hat, reduction='none')
#         total_mixloss = torch.mean(lam * loss + (1 - lam) * loss_hat)
#         return total_mixloss
